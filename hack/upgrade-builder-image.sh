...
then
  ...
  grep -r -E 'ghcr.io/Assertive-Yield/caph-builder:[0-9].*.*' -l | xargs sed -i -e "s/ghcr.io\/Assertive-Yield\/caph-builder:${VERSION}/ghcr.io\/syself\/caph-builder:${NEW_VERSION}/g"
