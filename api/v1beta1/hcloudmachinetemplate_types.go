...
// GetV1Beta1Conditions returns the observations of the operational state of the HCloudMachineTemplate resource.
func (r *HCloudMachineTemplate) GetV1Beta1Conditions() clusterv1.Conditions {
	return r.Status.Conditions
}

// SetV1Beta1Conditions sets the underlying service state of the HCloudMachineTemplate to the predescribed clusterv1.Conditions.
